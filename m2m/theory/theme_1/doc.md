...
![alt text](../../static/zigbee_architecture.png)

Zigbee - стандарт беспроводной связи для умных устройств.
Центральным узлом в сети Zigbee является **координатор**. К нему подключаются клиенты - устройства.

Координатор (он же FFD) — это самый главный узел. Он создает сеть, выбирает, на каком канале общаться, может выступать как «центр доверия» (trust center). 

Роутеры — устройства уже чуть попроще. Они служат зачастую ретрансляторами сообщений от конечных устройств. 

Конечные устройства (end device) — то, что мы объединяем в сеть, то есть выключатели, лампочки, датчики движения и прочие гаджеты.
...
* [Источник](https://reolink.com/blog/what-is-m2m/)
* [Источник](https://www.a1.digital/knowledge-hub/what-is-m2m-communication/)
